(function (window, document, undefined) {
    ...
    function DChat(args) {
        ...
        setTimeout(S.proxy(function () {
            var miscHeight = window.innerHeight - 40 - this.content.querySelector('nav').getBoundingClientRect().height
            this.historyList.style.height = this.miniblogList.style.height = this.profile.style.height = miscHeight + 'px';
            var sections = document.querySelectorAll('section');
            sections[0].style.height = innerHeight - 60 - document.querySelector('nav').getBoundingClientRect().height + 'px';
            sections[1].style.height = innerHeight - 10 - document.querySelector('#content footer').getBoundingClientRect().height + 'px';
        }, this), 200);
